                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col mt-auto">
                                <h5 className="bodyfont text-justify text-8 my-auto"><x>OneShot Affiliate</x> marketing is the simple form of education and business put together and you only need two minutes to understand it. The whole process is easy and effective. Here’s how it works, our website acts as an <x>educational platform</x> serving you with an amazing bundle of online courses. The courses allow you to <x>earn money</x> alongside learning and all this with a <x>minimal investment</x> and <x>quick return!</x> You make a payment of <x>Rs 1000</x> through our website and get access to our course programs along with the affiliate program. Now you work as a <x>part-time affiliate</x> of this company and try to refer it to as many people as you can. In return for each sale made by you, get a <x>commission of Rs 500</x> within a week. i.e We pay all our referrers once a week. So For eg. You make <x>100</x> sales then you earn <x>50,000</x>. Don't get us wrong but this is a business but a business with a system like no other. Through OneShot, you could be your <x>own ATM</x>. We host your website and data for 1 year for a one time cost of just Rs1000. Anyone can understand the whole concept in 60 seconds or less. There's really not much else to tell you. I told you it was simple.</h5>
                            </div>
                        </div>
                        <br/><br/><br/><br/>
                    </div>
