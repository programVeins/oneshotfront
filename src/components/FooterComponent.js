        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-sm-6">
                    <h3 className="white-text text-left headfont mr-auto text-5">Documentation</h3>
                    <div className="container">
                        <div className="row">
                            <div className="col"><Button onClick={toggle1} className="bodyfont text-9 white-text nonebutton">Terms and Conditions</Button></div>
                            <div className="col"><Button onClick={toggle2} className="bodyfont text-9 white-text nonebutton">Privacy Policy</Button></div>
                            <div className="col"><Button onClick={toggle3} className="bodyfont text-9 white-text nonebutton">Refund Policy</Button></div>
                        </div>
                    </div>
                    <br/>
