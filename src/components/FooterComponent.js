     ...
     return(
        ...
        <div className="container">
            <div className="row white-text">
                <div className="col-6 mt-5 text-left headfont"><h2>OneShot Affiliate</h2></div>
            ...
            <div className="row">
                <div className="col-sm-6 mt-auto">
                    ...
                    <h3 className="white-text text-justify headfont">Disclaimer</h3><p className="white-text text-justify bodyfont">
                ...
                <div className="col-sm-6">
                    <h3 className="white-text text-left headfont mr-auto">Links</h3>
                    ...
                    <br/>
                    <h3 className="white-text text-left headfont mr-auto">Social</h3>
                    ...
                    <h3 className="white-text text-left headfont mr-auto">Contact</h3>
                    <div className="row">
