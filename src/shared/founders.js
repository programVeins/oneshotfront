export const founders = [
    ...
    },
    {
        ...
        description: "Greetings! I am Sabesh, and I developed the website you're peering at right now. I'm the lead technician for OneShot Affiliate. I'm pursuing my engineering (IT) from SSN College of Engineering, Chennai. When not petting dogs or eating Maggi, you can find me coding away obviously for hours, with only the computer screen and the coffee mug in my focus. I've always wanted to create (Develop and Design) robust products that users can handle easily, with as much functionality as possible. OneShot Affiliate is my debut project, and I'm glad I teamed up to make this possible. Feel free to hit my Instagram @sabeshbharathi for anything from intense coding discussions to talking about Rick and Morty. Cheers!"
    },
]